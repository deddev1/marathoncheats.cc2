...
export const phrases = {
	es: {
		buy: 'Comprar Marathon Cheats', undetected: 'indetectables', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'Contacta support@marathoncheats.cc para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Marathon Cheats', undetected: 'indétectables', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'Contactez support@marathoncheats.cc pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Marathon Cheats kaufen', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Marathon Cheats', undetected: 'indetectáveis', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'Contacte support@marathoncheats.cc para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Marathon Cheats', undetected: 'indetectable', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'Contatta support@marathoncheats.cc per supporto o richieste legali.',
	},
	nl: {
		buy: 'Marathon Cheats kopen', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Marathon Cheats satın al', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'Destek ve yasal sorular için support@marathoncheats.cc.',
	},
	ar: {
		buy: 'اشترِ Marathon Cheats', undetected: 'غير مكتشف', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Marathon Cheatsを購入', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'サポート・法務: support@marathoncheats.cc',
	},
	ko: {
		buy: 'Marathon Cheats 구매', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => '지원 및 법무: support@marathoncheats.cc',
	},
	zh: {
		buy: '购买 Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => '支持与法务：support@marathoncheats.cc',
	},
	hi: {
		buy: 'Marathon Cheats खरीदें', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'सहायता: support@marathoncheats.cc',
	},
	id: {
		buy: 'Beli Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Marathon Cheats', undetected: 'undetected', maps: 'raids, maps, and Streets of Marathon',
		...
		legal: () => 'support@marathoncheats.cc för support och juridik.',
	},
};
