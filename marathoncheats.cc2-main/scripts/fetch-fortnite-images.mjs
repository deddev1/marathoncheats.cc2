...
/**
 * Bungie Marathon gallery shots — filenames include primary SEO keywords
 * (marathon, cheats, esp, aimbot, wallhack, battle-royale, etc.)
 */
const KEYWORD_ASSETS = [
	{ file: 'bungie-marathon-cheats-hero.webp', url: `${CDN_GALLERY}/marathon-gameplay-screenshots-2024_s2qs.1400.jpg` },
	{ file: 'bungie-marathon-cheats-cover.webp', url: `${CDN_B}/marathon-battle-royale-chapter-5-season-1-screenshot-a-1920x_xkzh.1400.jpg` },
	{ file: 'marathon-loadout-builder.webp', url: `${CDN_B}/marathon-battle-royale-chapter-5-season-1-screenshot-b-1920x_8z8k.1400.jpg` },
	{ file: 'bungie-marathon-cheats-aimbot-combat.webp', url: `${CDN_B}/marathon-battle-royale-chapter-5-season-1-screenshot-c-1920x_vu5r.1400.jpg` },
	{ file: 'marathon-squad-fight.webp', url: `${CDN_B}/marathon-battle-royale-chapter-5-season-1-screenshot-d-1920x_mzsk.1400.jpg` },
	{ file: 'bungie-marathon-cheats-esp-wallhack.webp', url: `${CDN_B}/marathon-battle-royale-chapter-5-season-1-train-1920x1080-a1_1nkx.1400.jpg` },
	{ file: 'bungie-marathon-cheats-package.webp', url: 'https://sm.ign.com/t/ign_latam/gallery/f/marathon-c/marathon-chapter-5-underground-images_5h3j.1400.jpg' },
	...
	{ file: 'marathon-battle-royale-combat.webp', url: `${CDN_A}/screenshot-7105-1725916496016_j9dr.1400.jpg` },
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'bungie-marathon-cheats-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		if (asset.file === 'bungie-marathon-cheats-hero.webp') heroBuffer = webp;
	} catch (err) {
...
console.log(`Done — attempted ${KEYWORD_ASSETS.length} keyword-named Bungie Marathon images.`);
