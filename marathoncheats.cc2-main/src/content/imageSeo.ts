...
export const IMAGE_SEO_REGISTRY: readonly ImageSeoEntry[] = [
  ...
  {
    id: 'blog-checkout-guide',
    path: '/blog-checkout-guide.webp',
    alt: 'Bungie Marathon checkout guide cover with official gameplay screenshot',
    title: 'Bungie Marathon Checkout Guide Cover',
    caption: 'Checkout guide cover using official Bungie Marathon press screenshots from IGN.',
    keywords: ['marathon cheats buy', 'marathon checkout guide', 'marathon cheats checkout'],
    pagePath: '/marathoncheats-buy',
    sourceFiles: ['public/blog-checkout-guide.webp'],
  },
  {
    id: 'blog-sony-bans',
